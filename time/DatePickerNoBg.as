...
package com.hyperspatial.time
{
	...
	public class DatePickerNoBg extends MovieClip{ 
	
		////////////////////------------< DEFAULT USER VARS >------------////////////////////
		public var language:String = "en";  //  "de" or "en"
		public var style:String = "blue";   //  "blue" or "white"
		////////////////////------------</ DEFAULT USER VARS >------------////////////////////
		
		////////////////////------------< CLASS VARS >------------////////////////////
		private var m = this;
		private var calendarWidth = 244;
		...
		// Constructor
		public function DatePickerNoBg(){
		...
		private function init(e:Event):void{
			...
			var next_btn:Sprite = m.addChild(drawArrow(calendarWidth-29,12,0));
		...
		private function drawDayNameRow(__x:Number,__y:Number):Sprite{
			...
			var nameRow:Sprite = cont.addChild(rect(calendarWidth-15,22,rowColor,0.5));
			//////////------------< Row of DayNames >------------//////////
		...
		private function drawDateGrid(mm:Number, yy:Number):void{
			...
			month_txt.y = 0;
			month_txt.x = ((calendarWidth/2)-(month_txt.width/2) -6);
			...
			for(var i:int = 1; i<=daysNr; i++){	
				...
				var nr_bgr:Sprite = nr_spr.addChild(rect(28,18,bgrColor,0.5));  // rect()-function see below
				nr_bgr.x = 3;
